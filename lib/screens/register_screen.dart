...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  // ── กำหนดความยาวรหัสผ่านขั้นต่ำที่นี่ ──
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration:
                                _deco(hint: 'ชื่อที่ต้องการแสดงในแอป'),
                            validator: (v) {
                          ...
                          if (_passwordController.text.isNotEmpty) ...[
                            ...
                            const SizedBox(height: 8),
                            _hintRow('อย่างน้อย $_minLen ตัวอักษร',
                                _passwordController.text.length >= _minLen),
                            _hintRow('ตัวพิมพ์ใหญ่ (A-Z)',
